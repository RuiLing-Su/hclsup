...
!function e(t, r, n) {
  ...
  9: [function (e, t, r) {
    ...
    t.exports = f, f.prototype.decode = function (e, t) {
      ...
      if ("bmpstr" === t) {
        ...
        var _r6 = "";
        for (var _e3 = 0; _e3 < _t8.length / 2; _e3++) _r6 += String.fromCharCode(_t8.readUInt16BE(2 * _e3));
        return _r6;
      }
      if ("numstr" === t) {
  ...
  12: [function (e, t, r) {
    ...
    t.exports = s, s.prototype.encode = function (e, t) {
      ...
      var s = 1;
      for (var _e7 = n.length; _e7 >= 256; _e7 >>= 8) s++;
      var f = i.alloc(2 + s);
      f[0] = o, f[1] = 128 | s;
      for (var _e8 = 1 + s, _t12 = n.length; _t12 > 0; _e8--, _t12 >>= 8) f[_e8] = 255 & _t12;
      return this._createEncoderBuffer([f, n]);
    }, f.prototype._encodeStr = function (e, t) {
      if ("bitstr" === t) return this._createEncoderBuffer([0 | e.unused, e.data]);
      if ("bmpstr" === t) {
        var _t13 = i.alloc(2 * e.length);
        for (var _r7 = 0; _r7 < e.length; _r7++) _t13.writeUInt16BE(e.charCodeAt(_r7), 2 * _r7);
      ...
      if ("string" == typeof e) {
        ...
        e = t[e].split(/[\s.]+/g);
        for (var _t14 = 0; _t14 < e.length; _t14++) e[_t14] |= 0;
      } else if (Array.isArray(e)) {
        e = e.slice();
        for (var _t15 = 0; _t15 < e.length; _t15++) e[_t15] |= 0;
      }
      ...
      for (var _t16 = 0; _t16 < e.length; _t16++) {
        var _r8 = e[_t16];
        for (n++; _r8 >= 128; _r8 >>= 7) n++;
      }
      var o = i.alloc(n);
      var a = o.length - 1;
      for (var _t17 = e.length - 1; _t17 >= 0; _t17--) {
        var _r9 = e[_t17];
        for (o[a--] = 127 & _r9; (_r9 >>= 7) > 0;) o[a--] = 128 | 127 & _r9;
      }
      ...
      var r = 1;
      for (var _t20 = e; _t20 >= 256; _t20 >>= 8) r++;
      var n = new Array(r);
      for (var _t21 = n.length - 1; _t21 >= 0; _t21--) n[_t21] = 255 & e, e >>= 8;
  ...
  14: [function (e, t, r) {
    ...
    n(o, i), t.exports = o, o.prototype.encode = function (e, t) {
      var r = i.prototype.encode.call(this, e).toString("base64"),
        n = ["-----BEGIN " + t.label + "-----"];
      for (var _e9 = 0; _e9 < r.length; _e9 += 64) n.push(r.slice(_e9, _e9 + 64));
    ...
    !function (t, r) {
      ...
      o.isBN = function (e) {
        ...
        var o,
          a,
          s = 0;
        if ("be" === r) for (i = e.length - 1, o = 0; i >= 0; i -= 3) a = e[i] | e[i - 1] << 8 | e[i - 2] << 16, this.words[o] |= a << s & 67108863, this.words[o + 1] = a >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, o++);else if ("le" === r) for (i = 0, o = 0; i < e.length; i += 3) a = e[i] | e[i + 1] << 8 | e[i + 2] << 16, this.words[o] |= a << s & 67108863, this.words[o + 1] = a >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, o++);
        return this.strip();
      ...
      Math.imul || (l = d), o.prototype.mulTo = function (e, t) {
        ...
        for (var a = 1; a < i; a <<= 1) for (var s = a << 1, f = Math.cos(2 * Math.PI / s), u = Math.sin(2 * Math.PI / s), c = 0; c < i; c += s) for (var h = f, d = u, l = 0; l < a; l++) {
          var p = r[c + l],
            b = n[c + l],
            m = r[c + l + a],
            y = n[c + l + a],
        ...
        for (var i = new o(1), a = new o(0), s = new o(0), f = new o(1), u = 0; t.isEven() && r.isEven();) t.iushrn(1), r.iushrn(1), ++u;
        for (var c = r.clone(), h = t.clone(); !t.isZero();) {
          for (var d = 0, l = 1; 0 == (t.words[0] & l) && d < 26; ++d, l <<= 1);
          if (d > 0) for (t.iushrn(d); d-- > 0;) (i.isOdd() || a.isOdd()) && (i.iadd(c), a.isub(h)), i.iushrn(1), a.iushrn(1);
          for (var p = 0, b = 1; 0 == (r.words[0] & b) && p < 26; ++p, b <<= 1);
          if (p > 0) for (r.iushrn(p); p-- > 0;) (s.isOdd() || f.isOdd()) && (s.iadd(c), f.isub(h)), s.iushrn(1), f.iushrn(1);
        ...
        for (var i, a = new o(1), s = new o(0), f = r.clone(); t.cmpn(1) > 0 && r.cmpn(1) > 0;) {
          ...
          if (u > 0) for (t.iushrn(u); u-- > 0;) a.isOdd() && a.iadd(f), a.iushrn(1);
  ...
  16: [function (e, t, r) {
    ...
    r.byteLength = function (e) {
      ...
      var t,
        ...
        c = 0,
        h = s > 0 ? a - 4 : a;
      for (r = 0; r < h; r += 4) t = i[e.charCodeAt(r)] << 18 | i[e.charCodeAt(r + 1)] << 12 | i[e.charCodeAt(r + 2)] << 6 | i[e.charCodeAt(r + 3)], f[c++] = t >> 16 & 255, f[c++] = t >> 8 & 255, f[c++] = 255 & t;
      ...
      for (var t, r = e.length, i = r % 3, o = [], a = 0, s = r - i; a < s; a += 16383) o.push(c(e, a, a + 16383 > s ? s : a + 16383));
  ...
  20: [function (e, t, r) {
    ...
    function a(e, t, r, n, i) {
      for (var o, a, s, f, u = r[0], c = r[1], h = r[2], d = r[3], l = e[0] ^ t[0], p = e[1] ^ t[1], b = e[2] ^ t[2], m = e[3] ^ t[3], y = 4, g = 1; g < i; g++) o = u[l >>> 24] ^ c[p >>> 16 & 255] ^ h[b >>> 8 & 255] ^ d[255 & m] ^ t[y++], a = u[p >>> 24] ^ c[b >>> 16 & 255] ^ h[m >>> 8 & 255] ^ d[255 & l] ^ t[y++], s = u[b >>> 24] ^ c[m >>> 16 & 255] ^ h[l >>> 8 & 255] ^ d[255 & p] ^ t[y++], f = u[m >>> 24] ^ c[l >>> 16 & 255] ^ h[p >>> 8 & 255] ^ d[255 & b] ^ t[y++], l = o, p = a, b = s, m = f;
      ...
      if ("dsa" === b.type) {
        ...
        return function (e, t, r) {
          var i,
            ...
            m = !1,
            y = c(o, f, e, r);
          for (; !1 === m;) i = d(f, y, r), p = l(u, i, a, f), 0 === (m = i.invm(f).imul(b.add(o.mul(p))).mod(f)).cmpn(0) && (m = !1, p = new s(0));
          return function (e, t) {
  ...
  47: [function (e, t, r) {
    ...
    t.exports = function (e, t, r, u, c) {
      ...
      var y = p < 8 ? 1 : 0;
      for (d = Math.min(e.length, l.length), e.length !== l.length && (y = 1), b = -1; ++b < d;) y |= e[b] ^ l[b];
      return 0 === y;
    };
  }, {
    "./curves.json": 44,
  ...
  65: [function (e, t, r) {
    (function (t) {
      ...
      function u(e) {
        for (var t = e.length < 0 ? 0 : 0 | c(e.length), r = o(t), n = 0; n < t; n += 1) r[n] = 255 & e[n];
        return r;
      }
      function c(e) {
      ...
      function b(e, t, r, n, i) {
        ...
        if (i) {
          var c = -1;
          for (o = r; o < s; o++) if (u(e, o) === u(t, -1 === c ? 0 : o - c)) {
            if (-1 === c && (c = o), o - c + 1 === f) return c * a;
          } else -1 !== c && (o -= o - c), c = -1;
        } else for (r + f > s && (r = s - f), o = r; o >= 0; o--) {
          for (var h = !0, d = 0; d < f; d++) if (u(e, o + d) !== u(t, d)) {
            h = !1;
            break;
          }
          if (h) return o;
      ...
      r.kMaxLength = 2147483647, t.TYPED_ARRAY_SUPPORT = function () {
        ...
        if (e === r) return 0;
        for (var n = e.length, i = r.length, o = 0, a = Math.min(n, i); o < a; ++o) if (e[o] !== r[o]) {
          n = e[o], i = r[o];
          break;
        }
        ...
        if (r >= n) return 1;
        if (this === e) return 0;
        for (var a = (o >>>= 0) - (i >>>= 0), s = (n >>>= 0) - (r >>>= 0), f = Math.min(a, s), u = this.slice(i, o), c = e.slice(r, n), h = 0; h < f; ++h) if (u[h] !== c[h]) {
          a = u[h], s = c[h];
          break;
        }
      ...
      t.prototype.slice = function (e, r) {
        ...
        var o = i - n;
        if (this === e && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(r, n, i);else if (this === e && n < r && r < i) for (var a = o - 1; a >= 0; --a) e[a + r] = this[a + n];else Uint8Array.prototype.set.call(e, this.subarray(n, i), r);
        return o;
        ...
        if (n <= r) return this;
        var a;
        if (r >>>= 0, n = void 0 === n ? this.length : n >>> 0, e || (e = 0), "number" == typeof e) for (a = r; a < n; ++a) this[a] = e;else {
    ...
    function g(e, t) {
      ...
      for (t = new i(t);;) {
        ...
        if (r.isEven() && r.iadd(s), r.testn(1) || r.iadd(f), t.cmp(f)) {
          if (!t.cmp(u)) for (; r.mod(c).cmp(h);) r.iadd(l);
  ...
  103: [function (e, t, r) {
    ...
    function h(e, t, r) {
      if (t) e.call(r);else for (var n = e.length, i = _(e, n), o = 0; o < n; ++o) i[o].call(r);
    }
    function d(e, t, r, n) {
      if (t) e.call(r, n);else for (var i = e.length, o = _(e, i), a = 0; a < i; ++a) o[a].call(r, n);
    }
    function l(e, t, r, n, i) {
      if (t) e.call(r, n, i);else for (var o = e.length, a = _(e, o), s = 0; s < o; ++s) a[s].call(r, n, i);
    }
    function p(e, t, r, n, i, o) {
      if (t) e.call(r, n, i, o);else for (var a = e.length, s = _(e, a), f = 0; f < a; ++f) s[f].call(r, n, i, o);
    }
    function b(e, t, r, n) {
      if (t) e.apply(r, n);else for (var i = e.length, o = _(e, i), a = 0; a < i; ++a) o[a].apply(r, n);
    }
    function m(e, t, r, i) {
      var o, a, s;
  ...
  148: [function (e, t, r) {
    (function (e) {
      ...
      r.resolve = function () {
        ...
        for (var i = n(e.split("/")), o = n(t.split("/")), a = Math.min(i.length, o.length), s = a, f = 0; f < a; f++) if (i[f] !== o[f]) {
          s = f;
          break;
        }
        var u = [];
  ...
  153: [function (e, t, r) {
    ...
    function d(e, t, r) {
      ...
      for (var u = a.allocUnsafe(f + h[e]), d = a.allocUnsafe(f + h[e]), l = 0; l < f; l++) u[l] = 54 ^ t[l], d[l] = 92 ^ t[l];
  ...
  189: [function (e, t, r) {
    ...
    n(f, i), f.prototype.init = function () {
      ...
      for (var t, r = this._w, n = 0 | this._a, i = 0 | this._b, o = 0 | this._c, s = 0 | this._d, f = 0 | this._e, p = 0 | this._f, b = 0 | this._g, m = 0 | this._h, y = 0; y < 16; ++y) r[y] = e.readInt32BE(4 * y);
  ...
  191: [function (e, t, r) {
    ...
    n(f, i), f.prototype.init = function () {
      ...
      for (var t = this._w, r = 0 | this._ah, n = 0 | this._bh, i = 0 | this._ch, o = 0 | this._dh, s = 0 | this._eh, f = 0 | this._fh, g = 0 | this._gh, v = 0 | this._hh, w = 0 | this._al, _ = 0 | this._bl, E = 0 | this._cl, M = 0 | this._dl, S = 0 | this._el, k = 0 | this._fl, A = 0 | this._gl, x = 0 | this._hl, R = 0; R < 32; R += 2) t[R] = e.readInt32BE(4 * R), t[R + 1] = e.readInt32BE(4 * R + 4);
      for (; R < 160; R += 2) {
        var I = t[R - 30],
          B = t[R - 30 + 1],
          T = l(I, B),
            ...
            var t = this,
              r = n.addFunction(function (r, i, o, a, s, f, u, c, h, d, l) {
                ...
                if ("" === t._pix_format || t._pix_format.length <= 0) {
                  for (var w = n.HEAPU8.subarray(l, l + d), _ = "", E = 0; E < w.length; E++) _ += String.fromCharCode(w[E]);
                  t._pix_format = _;
                }
  ...
  197: [function (e, t, r) {
    (function (r, n, i) {
      ...
      var k = {
        ...
        x = new Array(14);
      function R(e, t) {
        for (var r = 0; r < 14; r++) if (!x[r]) return x[r] = e, A + r;
      ...
      var ce = [],
        ...
        pe = !1;
      function be() {
        if (s.preRun) for ("function" == typeof s.preRun && (s.preRun = [s.preRun]); s.preRun.length;) ve(s.preRun.shift());
        ue(ce);
      }
      function me() {
      ...
      function ge() {
        if (s.postRun) for ("function" == typeof s.postRun && (s.postRun = [s.postRun]); s.postRun.length;) we(s.postRun.shift());
        ue(le);
      }
      function ve(e) {
        ce.unshift(e);
      ...
      function Ke(e) {
        ...
        var n = [],
          i = 0;
        for (var a in He) if ("string" == typeof He[a]) {
          var s = a + "=" + He[a];
          n.push(s), i += s.length;
        }
      ...
      var Ve = {
        ...
        Xe = {
          ...
          relative: function relative(e, t) {
            ...
            for (var n = r(e.split("/")), i = r(t.split("/")), o = Math.min(n.length, i.length), a = o, s = 0; s < o; s++) if (n[s] !== i[s]) {
              a = s;
              break;
            }
            var f = [];
        ...
        Ze = {
          ...
          resizeFileStorage: function resizeFileStorage(e, t) {
            if (e.usedBytes != t) {
              ...
              if (e.contents || (e.contents = []), e.contents.length > t) e.contents.length = t;else for (; e.contents.length < t;) e.contents.push(0);
              e.usedBytes = t;
            }
          },
          node_ops: {
            ...
            rename: function rename(e, t, r) {
              if (et.isDir(e.mode)) {
                ...
                if (n) for (var i in n.contents) throw new et.ErrnoError(55);
              }
          ...
          stream_ops: {
            read: function read(e, t, r, n, i) {
              ...
              if (a > 8 && o.subarray) t.set(o.subarray(i, i + a), r);else for (var s = 0; s < a; s++) t[r + s] = o[i + s];
              return a;
            },
            write: function write(e, t, r, n, i, o) {
              ...
              if (Ze.expandFileStorage(a, i + n), a.contents.subarray && t.subarray) a.contents.set(t.subarray(r, r + n), i);else for (var s = 0; s < n; s++) a.contents[i + s] = t[r + s];
        ...
        et = {
          ...
          mkdirTree: function mkdirTree(e, t) {
            for (var r = e.split("/"), n = "", i = 0; i < r.length; ++i) if (r[i]) {
              n += "/" + r[i];
              try {
                et.mkdir(n, t);
              } catch (e) {
          ...
          createDataFile: function createDataFile(e, t, r, n, i, o) {
            ...
            if (r) {
              if ("string" == typeof r) {
                for (var u = new Array(r.length), c = 0, h = r.length; c < h; ++c) u[c] = r.charCodeAt(c);
                r = u;
              }
              et.chmod(f, 146 | s);
              var d = et.open(f, "w");
          ...
          createLazyFile: function createLazyFile(e, t, r, n, i) {
            ...
            return Object.keys(f.stream_ops).forEach(function (e) {
              ...
              if (o.slice) for (var s = 0; s < a; s++) t[r + s] = o[i + s];else for (s = 0; s < a; s++) t[r + s] = o.get(i + s);
              return a;
            }, f.stream_ops = u, f;
          },
      ...
      function vt(e) {
        ...
        for (var r = Math.max(t, 16777216); r < e;) r = r <= 536870912 ? ie(2 * r, 65536) : Math.min(ie((3 * r + 2147483648) / 4, 65536), 2147418112);
        return !!gt(r);
      }
      var wt = {
        xhrs: [],
      ...
      if (s.asm = lr, s.ccall = N, s.cwrap = U, s.addFunction = R, Re = function e() {
        pr || Mr(), pr || (Re = e);
      }, s.run = Mr, s.preInit) for ("function" == typeof s.preInit && (s.preInit = [s.preInit]); s.preInit.length > 0;) s.preInit.pop()();
      B = !0, Mr(), t.exports = s;
...
},{"./decoder":1,"./raw-parser":4}],3:[function(require,module,exports){
"use strict";
...
function initPlayer() {
  ...
  yuv = _renderYuv420p["default"].setupCanvas(canvas, {
  ...
  decoderMod.bindCallback(function (y, u, v, stride_y, stride_u, stride_v, width, height) {
...
function playSelectedChannel() {
  ...
  var wsUrl = "websocket/".concat(id, "/").concat(selectedChannel);
...
},{"./index":2,"./render-yuv420p":5}],4:[function(require,module,exports){
(function (global){(function (){
"use strict";
